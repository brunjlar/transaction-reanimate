...
uniswap = reanimate $ andThen background $ runAnimationM $ do
    ...
    _oBob2     <- outputM "Bob" "181B" Nothing tx5 (5, 4)
    ...
    _oAlice3   <- outputM "Alice" "1070A+1869B" Nothing tx8 (3, -1)
    ...
    _oFactory3 <- outputM "Factory" "US NFT" (Just "[]") tx9 (7.8, 3)
    _oCharlie3 <- outputM "Charlie" "430A+750B" Nothing tx9 (7.8, -3)
    delayM
